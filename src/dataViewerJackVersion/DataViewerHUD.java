...
public class DataViewerHUD implements DrawListener {
    ...
    private Draw window;
    private dataViewerJackVersion.GUIState GUIState;
...
//        boolean needsUpdatePlotData = false;
        ArrayList<DoCommand> invoker = new ArrayList<>();
        ...
        if(key == 'Q') {
            ...
            if(key == 'P') {
                ...
                if(dataViewer.getM_plotData() == null) {
                    ...
                    invoker.add(new DoUpdatePlotDataCommand(this));
                }
                invoker.add(new DoUpdateCommand(this));
            }
            else if(key == 'C') {
                // set the Country
...
//        }
    ...
    public void updatePlotData(){dataViewer.updatePlotData();}
